...
HD_PWD='C:/Users/saber/Desktop/design projects/UART/UART/UART.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log UART_sender.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source UART_sender.tcl
